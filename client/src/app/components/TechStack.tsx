...
function TechCard({ tech, index, inView }: { tech: typeof technologies[0], index: number, inView: boolean }) {
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl mb-6 text-white tracking-tighter font-black">
            Modern <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-blue-400">Architecture.</span>
          </h2>
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto font-medium leading-relaxed">
            Built with a high-performance stack designed for scale, speed, and a seamless developer experience.
          </p>
        </motion.div>
          ...
          <div className="group relative">
            ...
            <div className="relative px-8 py-4 glass-strong rounded-2xl border border-white/10 flex items-center gap-6 divide-x divide-white/10">
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => (
                    ...
                    >
                      <Zap className={`w-4 h-4 ${i === 1 ? 'text-brand-primary' : i === 2 ? 'text-blue-400' : 'text-cyan-400'}`} />
                    </div>
                  ))}
                </div>
                <div className="flex flex-col">
                  <span className="text-[10px] text-neutral-500 font-black uppercase tracking-widest">Performance</span>
                  <span className="text-white font-bold text-sm tracking-tight">10ms Latency</span>
                </div>
              </div>
              ...
              <div className="pl-6 flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-neutral-500 font-black uppercase tracking-widest">Reliability</span>
                  <span className="text-white font-bold text-sm tracking-tight">99.9% Uptime</span>
                </div>
              </div>
            </div>
          </div>
